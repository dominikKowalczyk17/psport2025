...
export const mockNews: News[] = [
  ...
  },
  {
    ...
    author: authors[1],
    category: categories[1],
    subCategory: { title: 'Rozgrywki', href: 'rozgrywki' },
  ...
  // FORMUŁA 1
  {
    ...
    subCategory: { title: 'Monako', href: 'monako' },
  ...
  // SKOCZKI – Turniej Czterech Skoczni
  {
    ...
    author: authors[1],
    // Assuming you have a separate category for ski jumping (e.g. categories[10])
    category: categories[9],
    subCategory: {
      title: 'Turniej Czterech Skoczni',
      href: 'turniej-czterech-skoczni',
    },
  ...
  // BIATHLON
  {
    ...
    author: authors[2],
    category: categories[6],
    subCategory: { title: 'Sztafeta', href: 'sztafeta' },
  ...
  // MARATON
  {
    ...
    subCategory: { title: 'Rekordy', href: 'rekordy' },
  ...
  // FORMUŁA 1 - Kubica
  {
    ...
    subCategory: { title: 'Powrót', href: 'powrot' },
  ...
  // SIATKÓWKA - Igrzyska Olimpijskie
  {
    ...
    author: authors[1],
    category: categories[4],
    subCategory: { title: 'Igrzyska', href: 'igrzyska' },
  ...
  // PIŁKA NOŻNA - Transfery
  {
    ...
    author: authors[2],
    category: categories[1],
    subCategory: { title: 'Transfery', href: 'transfery' },
  ...
  // KOSZYKÓWKA - Rekordy NBA
  {
    ...
    author: authors[0],
    category: categories[2],
    subCategory: { title: 'Rekordy NBA', href: 'rekordy-nba' },
  ...
  // KOŁARSTWO - Tour de France
  {
    ...
    author: authors[1],
    category: categories[9],
    subCategory: { title: 'Tour de France', href: 'tour-de-france' },
  ...
  // PIŁKA NOŻNA - El Clasico
  {
    ...
    author: authors[0],
    category: categories[1],
    subCategory: { title: 'El Clasico', href: 'el-clasico' },
