...
export const mockNews: News[] = [
  ...
  },
  {
    ...
    excerpt:
      "Historyczny sukces mistrzów Polski. Raków pokonał FC Kopenhaga w dwumeczu",
  ...
  },
  {
    ...
    excerpt:
      "Biało-czerwoni pokonali Czechów 3:0 i są o krok od awansu na Euro 2024",
    content:
      "Reprezentacja Polski rozegrała jeden z najlepszych meczów w ostatnich latach...",
  ...
  // SIATKÓWKA (categoryId: 3)
  {
    ...
    excerpt:
      "Kędzierzynianie pokonali Trentino w półfinale i zagrają o czwarty z rzędu triumf w Champions League",
    content:
      "Siatkarze Grupy Azoty ZAKSY Kędzierzyn-Koźle dokonali niemożliwego...",
  ...
  },
  {
    ...
    content:
      "W decydującym meczu zespół z Jastrzębia-Zdroju nie dał szans rywalom...",
  ...
  // TENIS (categoryId: 4)
  {
    ...
    excerpt:
      "Polska tenisistka zdobywa czwarty tytuł w Katarze, nie tracąc seta w całym turnieju",
    content:
      "Iga Świątek po raz kolejny udowodniła, że kort w Doha to jej drugi dom...",
  ...
  },
  {
    ...
    excerpt:
      "Polski tenisista pokonał Daniiła Miedwiediewa w finale turnieju ATP Masters 1000",
  ...
  },
  {
    ...
    excerpt:
      "Niesamowity mecz w finale US Open 2025. Alcaraz przegrywa z Sheltonem",
  ...
  // KOSZYKÓWKA (categoryId: 5)
  {
    ...
    excerpt:
      "Jeremy Sochan z historycznym występem w barwach San Antonio Spurs",
  ...
  },
  {
    ...
    excerpt:
      "Koszykarze Śląska Wrocław zdobywają mistrzostwo Polski po 20 latach przerwy",
  ...
  },
  {
    ...
    excerpt:
      "Reprezentacja Polski wywalczyła historyczny awans na igrzyska olimpijskie",
    content:
      "Biało-czerwoni pokonali Litwę w decydującym meczu kwalifikacji...",
